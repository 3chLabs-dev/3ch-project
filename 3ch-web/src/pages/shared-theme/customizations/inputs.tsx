...
/**
 * MUI Components 커스터마이징
 * - `satisfies Components<Theme>`로 타입 안정성 확보
 * - styleOverrides의 theme 파라미터 타입을 Theme로 명시
 */
  ...
  MuiButton: {
    styleOverrides: {
      root: ({ theme }: { theme: Theme }) => ({
        ...
        // ⚠️ variants는 원래 theme.components.MuiButton.variants 쪽이 정석인데,
        // 템플릿 코드에서 styleOverrides.root 안에 넣는 패턴을 쓰는 경우가 있음.
        // 그대로 유지 (동작 기반). 타입은 satisfies가 잡아줌.
        variants: [
          {
            props: { size: "small" },
