...
Each score cell can include two small printed black square markers and a centered outlined score-entry area. These are fixed layout guides, not scores. Ignore every printed number, label, line, and black square on the sheet. Read only the single large handwritten digit written in the centered score-entry area.
