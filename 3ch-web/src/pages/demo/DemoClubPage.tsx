...
export default function DemoClubPage() {
  ...
  if (rankingOpen) return <Stack spacing={2.2} sx={{ pb: 3 }}>
    <Seo title="샘플 클럽 순위" description="우리리그 샘플 클럽의 회원별 경기 전적과 순위 기능을 둘러보세요." path="/demo/club" />
  ...
  return <Stack spacing={2} sx={{ pb: 3 }}>
    <Seo title="샘플 클럽" description="회원 구성과 부수, 경기 전적 및 클럽 순위를 샘플 데이터로 체험해보세요." path="/demo/club" />
