    ...
    return (
      <Box sx={{ pb: 4 }}>
          ...
          <>
            ...
            {canInteract && (
              <IconButton size="small" onClick={() => setShareDialogOpen(true)}>
                <CurvedShareIcon fontSize="small" />
              </IconButton>
            )}
          </>
          {/* // )} */}
        ...
        >
          ...
          <Box sx={infoRowSx}>
            <Typography sx={labelSx}>코트 수</Typography>
            {canManage ? (
              <TextField
                type="number"
            ...
            league.format === "단일리그 + 토너먼트" ? (
              <Stack spacing={1} sx={{ mt: 1 }}>
                ...
                <Button
                  ...
                  onClick={() => navigate(`/league/${id}/tournament?back=detail`)}
                >
              ...
              <Button
                ...
                onClick={() => {
                  if (league.format?.includes("토너먼트")) {
                    navigate(`/league/${id}/tournament?back=detail`);
                  } else if (league.format === "GPT 인식") {
                    navigate(`/league/${id}/gpt-vision?back=detail`);
                  } else {
                    navigate(`/league/${id}/bracket?back=detail`);
                  }
                }}
              >
