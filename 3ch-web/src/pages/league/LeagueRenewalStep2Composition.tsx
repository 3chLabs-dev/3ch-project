...
import { Box, Button, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, FormControlLabel, Radio, RadioGroup, Stack, Typography } from "@mui/material";
...
export default function LeagueRenewalStep2Composition() {
  ...
  return (
    <Box sx={{ px: 2.5, pt: 2 }}>
      ...
      <Dialog open={requirementDialogOpen} onClose={() => setRequirementDialogOpen(false)} fullWidth maxWidth="xs">
        ...
        <DialogActions>
          <Button onClick={() => setRequirementDialogOpen(false)} sx={{ fontWeight: 700 }}>확인</Button>
        </DialogActions>
      </Dialog>
    </Box>
  );
