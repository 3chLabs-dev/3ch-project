...
const leagueCards = [
  { title: "리그 생성", body: "AI가 자동으로 생성해주는 추천 프로그램을 통해 단식 / 복식 / 단체전을 선택할 수 있고, 풀리그, 조별리그, 토너먼트 등 다양한 형식으로 빠르게 생성할 수 있습니다." },
...
const programCards = [
  ...
  { title: "풀리그 + 토너먼트", body: "예선 리그를 진행한 뒤 본선 토너먼트로 이어지는 혼합형 운영도 지원합니다." },
      ...
      <Box sx={{ width: "min(1120px, calc(100% - 32px))", mx: "auto", py: { xs: 5, md: 8 } }}>
        <Stack spacing={6}>
          ...
          <Box id="AI" sx={sectionAnchorSx}>
            <SectionTitle eyebrow="AI PHOTO RECOGNITION" title="AI 사진 인식" description="회원·참가자 명단부터 수기로 작성한 대진표까지 사진 한 장만 올리면 AI가 사진을 인식하여 한 번에 결과를 등록할 수 있습니다." />
            <Box sx={{ mt: 3 }}>
